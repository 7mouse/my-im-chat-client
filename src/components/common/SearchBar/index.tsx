...
const SearchBar = ({setSearch}:props) => {
  ...
  return (
    <div className="w-64 h-16 flex justify-start items-end">
      <div className="flex-1 flex h-11 items-center justify-between">
        <div className="h-6 ml-3 mb-3 flex-1 flex justify-between items-center bg-gray-300  rounded-md">
        ...
        <div onClick={()=>setSearch(text)} className="w-5 h-5 mr-3 mb-3 ml-3 rounded-sm bg-gray-300 cursor-pointer">
